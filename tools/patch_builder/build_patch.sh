...
CHANGELOG=${2:-"Void of Oblivion 1.7.2:\n- Меню «Настройки» на главном экране и в хабе\n- Регулировка общей громкости звука и музыки (ползунок 0..10, по умолчанию 7/10)\n- Сохранение параметров громкости в профиль игрока\n- Оптимизация анимации Сверхспособности"}
