...
CHANGELOG=${3:-"Void of Oblivion 1.3.3:\n- Исправлена ошибка регистрации и привязки аккаунта (OPERATION_NOT_ALLOWED)\n- Улучшена облачная синхронизация профиля и прогресса персонажей"}
