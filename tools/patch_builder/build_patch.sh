...
CHANGELOG=${3:-"Void of Oblivion 1.3.2 (Hotfix):\n- Исправлена кликабельность модального окна регистрации/привязки аккаунта\n- Добавлена кнопка пропуска регистрации для игры в гостевом режиме\n- Внедрено фоновое Zero-Click автообновление для обязательных патчей"}
